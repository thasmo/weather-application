...
<template>
	<div class="p-4 border-b border-primary-100 sm:(p-5) dark:(border-gray-700)">
		<h2 class="text-2xl text-gray-800 font-medium dark:(text-gray-100)">{{ locationName }}</h2>
		...
		<button
			...
			<span class="i-ri-map-pin2-line"></span>
		</button>
		...
		<div v-if="isLoading" class="mt-4 flex items-center">
			<div class="i-ri-loader-4-line text-xl text-primary-600 mr-2 animate-spin"></div>
